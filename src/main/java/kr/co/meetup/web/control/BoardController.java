...
public class BoardController extends HttpServlet {
	...
	private void doProcess(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (cmd == null || cmd.equals("listBoard")) {
			...
			System.out.println("WriteFormBoardAction 실행!");
			action = new WriteFormBoardAction();
		} else if (cmd.equals("writeOkBoard")) {
			System.out.println("WriteBoardAction 실행!");
			action = new WriteBoardAction();
		}

		/*
		 * if (cmd == null || cmd.equals("listBoard")) { action = new ListBoardAction();
		 * } else if (cmd.equals("writeBoard")) { action = new WriteFormBoardAction(); }
		 * else if (cmd.equals("writeOkBoard")) { action = new WriteBoardAction(); }
		 * else if (cmd.equals("detailBoard")) { action = new DetailBoardAction(); }
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if (cmd.equals("writeOkBoard")) {
				...
				// 메인 이미지의 원본파일명, 저장파일명
				String boardImgOriginalImg = mr.getOriginalFileName("boardImgOriginalImg");
				String boardImgSaveImg = mr.getFilesystemName("boardImgSaveImg");
				;
